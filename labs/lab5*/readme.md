...
<img src="img/config.jpg" width="700">

3. Для отправки уведомлений в Telegram был создан бот и получен bot_token, установлен chat_id для отправки сообщений. Теперь бот отправляет определенные алерты в соответствии с заданным интервалом.

<img src="img/alert.jpg" width="300">
