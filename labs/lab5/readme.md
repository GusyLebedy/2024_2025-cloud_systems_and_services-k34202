...
Дашборд про бд PostgreSQL.

<img src="img/dashboard2.jpg" width="700">

<b>Средняя загрузка CPU (Average CPU Usage):</b> Значения CPU time остаются в диапазоне 2.4s - 2.55s. Такое маленько колебание свидетельствует о стабильной загрузке процессора. 

Память используется стабильно, значения Resident Mem (постоянно занятая память) в районе 605-672 кБ. Это указывает на эффективное использование памяти без резких скачков, что хорошо для производительности базы данных.

<b>Active Sessions:</b> В списке активных сессий три активности (asset, terminal, terminalv1.5).

Пик транзакций происходит в районе 13:00 - 14:00, тогда их количество достигает почти 300. Это указывает на часы пикового использования, которые стоит учитывать при планировании резервного копирования или других интенсивных операций.

<b>Вывод</b>: мониторинг, мониторинг и ещё раз мониторинг!
